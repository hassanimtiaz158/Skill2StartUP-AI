          ...
          <div className="rounded-2xl border border-border bg-white p-8 shadow-xl shadow-slate-200/50">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label htmlFor="signup-name" className="text-sm font-semibold text-ink flex items-center gap-2">
              ...
              {/* Email */}
              <div className="space-y-2">
                <label htmlFor="signup-email" className="text-sm font-semibold text-ink flex items-center gap-2">
              ...
              {/* Password */}
              <div className="space-y-2">
                <label htmlFor="signup-password" className="text-sm font-semibold text-ink flex items-center gap-2">
                    ...
                    {passwordChecks.map((check) => {
                      ...
                      return (
                        <div key={check.label} className="flex items-center gap-2">
                          <Check className={`h-3.5 w-3.5 ${passed ? 'text-success' : 'text-ink-faint'}`} />
              ...
              <div className="flex items-start gap-2">
                <input type="checkbox" required className="mt-0.5 h-4 w-4 rounded border-border bg-white text-primary focus:ring-primary/20" />
