...
import { Rocket, Mail, Lock, Eye, EyeOff, ArrowRight, Check } from 'lucide-react';
            ...
            <div className="rounded-2xl border border-border bg-white/90 backdrop-blur-sm p-8 shadow-xl shadow-slate-200/50">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-y-2">
                  ...
                  <button type="button" className="text-sm text-primary hover:text-primary-hover transition-colors font-medium whitespace-nowrap">
                    Forgot password?
                  </button>
                </div>
