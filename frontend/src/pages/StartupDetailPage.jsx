    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center pt-24">
        <div className="max-w-sm text-center p-8">
          ...
          <button onClick={() => navigate('/results')} className="h-12 px-6 rounded-xl bg-gradient-to-r from-primary to-accent-2 text-white text-sm font-semibold">Back to Results</button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-bg pt-24 pb-12 md:pt-28 md:pb-16 relative">
      ...
      <div className="container max-w-4xl relative">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
          className="rounded-2xl border border-border bg-white p-6 md:p-8 mb-6 shadow-lg shadow-slate-200/50">
          <div className="flex flex-col sm:flex-row items-start gap-5">
            <ScoreGauge score={plan.opportunity_score} />
            <div className="flex-1 min-w-0">
              <h1 className="text-2xl md:text-3xl font-extrabold text-ink mb-2 truncate">{plan.startup_name}</h1>
        ...
        <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-4 mb-12">
        ...
        <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6 mb-12">
          <motion.div variants={fadeUp}>
            <div className="rounded-2xl border border-border bg-white p-6 shadow-lg shadow-slate-200/50">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            <button
              onClick={handleSave}
              disabled={saving || saved}
              className={`flex items-center justify-center gap-2 h-12 px-8 text-sm font-bold transition-all duration-200 rounded-xl ${
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 h-12 px-8 border border-border bg-white text-sm font-semibold text-ink hover:bg-slate-50 hover:border-border-strong transition-all duration-200 rounded-xl"
            >
              View Dashboard
            </button>
          </motion.div>
